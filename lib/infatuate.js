...
(function() {
  var Counter, DefaultDict, Distribution, LanguageModel, PUNCTUATION, WHITESPACES, add_space, all, binary_search, binary_search_aux, count_triplets, filepath, fs, model, root, text, tokenize,
  ...
  LanguageModel = (function() {
    ...
    LanguageModel.prototype.draw_sentence = function() {
      var token, tokens;
    ...
    LanguageModel.prototype.draw_text = function(min_length) {
      var text;

      text = "";
      while (text.length < min_length) {
        text += this.draw_sentence() + " ";
      }
      return text;
    };
  ...
  if ((typeof process !== "undefined" && process !== null ? process.argv.length : void 0) === 3) {
    fs = require('fs');
